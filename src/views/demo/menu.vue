<template>
  <div>
    ...
    <transition name="dropdown">
      <div v-show="isShow" class="dropdown" :style="{ left: isCollapse ? '270px' : '420px' }" @click="hideDropDown($event, true)">
        <div class="dropdown-content" @mouseleave="hideDropDown" @click.stop="">
